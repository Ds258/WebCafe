...
public partial class CuaHangBanCafeContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("workstation id=coffee-db.mssql.somee.com;packet size=4096;user id=Ds2508_SQLLogin_1;pwd=6hym5v3aqg;data source=coffee-db.mssql.somee.com;persist security info=False;initial catalog=coffee-db");
